...
WebUI.click(findTestObject('Cart Page/backToShoppingButton'))

WebUI.click(findTestObject('Home Page/Remove Product Button/button_9.99_remove-sauce-labs-bike-light'))

WebUI.click(findTestObject('Home Page/Remove Product Button/button_7.99_remove-sauce-labs-onesie'))

WebUI.click(findTestObject('Home Page/cartLinkButton'))

WebUI.verifyElementNotPresent(findTestObject('Cart Page/Product Added/sauceLabsBikeLightProduct'), 0)

WebUI.verifyElementNotPresent(findTestObject('Cart Page/Product Added/sauceLabsOnesieProduct'), 0)
